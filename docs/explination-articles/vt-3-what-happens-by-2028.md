...
This piece covers what the clock is, what is on the table, and what to watch.

It does not tell you how to vote. Nobody can tell you that.

Think about two towns. One has a new school and more kids coming. One has a 60 year old building and half the kids it used to have.

Those two towns do not have the same right answer.

---

## The short version

Act 170 makes every school district in Vermont sit down with its neighbors and study one question.

Should we become one district?

Every committee has to write a report. Every report has to show the numbers. Then voters decide.

That is it. No town is forced into anything. But no town gets to skip the conversation either.
...
Act 170's real power is not legal. It is financial.

**School buildings.** This is the big one. A district that merges can get the state to pay up to **75 percent** of the cost of a new or rebuilt school. A district that does not merge tops out at **30 percent**.
...
**Planning money.** There is a $900,000 fund for facilities planning grants.
...
## The funding formula is still coming, just later

In 2025 Vermont voted to replace its whole funding system with a **foundation formula**. The state would decide what one student's education costs, then pay that per student, plus extra for students who cost more.
...
Everything above is 2028 and beyond. Here is what is already happening.

Remember the excess spending penalty from Piece 2. If a district spends above a set line, the money over that line gets taxed twice.

A separate law this year is walking that line down. To 115.5 percent of the state average, then 114.5 percent, then lower.

Nothing about a merger study changes that. Your district's costs keep rising and the line keeps dropping. Business managers are already feeling this in next year's budget.

If your board seems stressed about money in a year when nothing obvious changed, this is usually why.

---

## One small change worth knowing
...
Act 170 does not close a school. It does not merge a district. It does not change a tax bill.

What it does is make every town in Vermont look hard at its own numbers, in public. Then it hands the choice to voters.

Some towns will come out of this better off merged. Some will come out better off alone. Both are real answers. Which one is yours depends on math that belongs to your district alone.

The towns that do well will be the ones that understood their numbers before March 2028. Not after.

You have until then. Use it.
